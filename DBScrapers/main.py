...
def get_goodreads_data(isbn):
    ...
    url = f"https://www.goodreads.com/search?q={isbn}&search_type=books&search%5Bfield%5D=isbn"
    ...
    if response.status_code == 200:
        ...
        if book:
            ...
            if book_response.status_code == 200:
                ...
                # Pobranie danych
                title = book_soup.find("span", itemprop="name").text if book_soup.find("span", itemprop="name") else None
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for future in as_completed(future_to_isbn):
            ...
            try:
                ...
                print(f"Before scraping (ISBN: {isbn}):\n{old_data[['isbn', 'title', 'author', 'rating_goodreads', 'publication_date']]}")
                ...
                if scraped_data:
                    ...
                    df.loc[df['isbn'] == isbn, 'author'] = scraped_data.get("author", np.nan)
                    ...
                    print(f"After scraping (ISBN: {isbn}):\n{new_data[['isbn', 'title', 'author', 'rating_goodreads', 'publication_date']]}")
